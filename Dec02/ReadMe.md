...
- `1-3 a: `__`a`__`b`__`c`__`de` is __valid__: position `1` contains `a` and position `3` does not.
- `1-3 b: `__`c`__`d`__`e`__`fg` is __invalid__: neither position `1` nor position `3` contains `b`.
- `2-9 c: c`__`c`__`cccccc`__`c`__ is __invalid__: both position `2` and position `9` contain `c`.
